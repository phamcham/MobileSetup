...
public class AddAdNetworkItemsForMediation {
#if UNITY_IOS
    ...
    private const string SKADNETWORKS_RELATIVE_PATH = "PhamCham/GoogleMobileAds/Editor/MediationsSKAdNetworkItems.xml";
    ...
    public static void OnPostProcessBuild(BuildTarget buildTarget, string path) {
        ...
        Debug.Log("Add \"SKAdNetworkItems\" for mediations to Info.plist");
    }
...
#pragma warning restore 0168
        {
            NotifyBuildFailure("MediationsSKAdNetworkItems.xml not found", false);
        }
        catch (IOException e) {
            NotifyBuildFailure("Failed to read MediationsSKAdNetworkItems.xml: " + e.Message, false);
        }
...
#pragma warning restore 0168
    ...
    private static void NotifyBuildFailure(string message, bool showOpenSettingsButton = true) {
        string dialogTitle = "Google Mobile Ads Mediation";
        ...
        ThrowBuildException("[GoogleMobileAdsMediations] " + message);
    }
